---
title: OUTLOOK_1
description: OUTLOOK_1 Error Code
---

## Issue:

- We are missing Mails.Read.All and/or Calendars.Read.All permission for the app.

## Resolution:

- Please navigate to the Azure portal. Select Azure Active Directory, then navigate to Enterprise applications and find the app you setup for Glean. Please ensure this App has the permissions `Mails.Read.All` and `Calendars.Read.All` and admin consent has been granted. 
...
- Please ensure this App has the permissions `Mails.Read.All` and `Calendars.Read.All`, and admin consent has been granted. 
