---
title: O365-7
description: O365-7 Error Code
---

## Issue:

- We are missing Group.Read.All or Directory.Read.All permission for the app.
...
- Please ensure this App has the permission `Group.Read.All` or `Directory.Read.All`, and admin consent has been granted. 
