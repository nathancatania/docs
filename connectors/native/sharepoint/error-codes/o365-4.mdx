---
title: O365-4
description: O365-4 Error Code
---

## Issue:

- We are missing Reports.Read.All permission for the app.
...
- Please ensure this App has the permission `Reports.Read.All` and admin consent has been granted. 
