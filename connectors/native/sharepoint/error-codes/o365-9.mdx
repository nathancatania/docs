---
title: O365-9
description: O365-9 Error Code
---

## Issue:

- We are missing Sites.Read.All permission for the app.
...
- Please ensure this App has the permission `Sites.Read.All` and admin consent has been granted. 
